...
export default {
  ...
  COVER_MOSAIC: "Mosaic fill",
  COVER_MOSAIC_DESC: "Replaces the image: the cover becomes a mosaic of tiles in this color scheme (pattern differs per note). Choose none to show the image again.",
  DEFAULT_COVER_MOSAIC: "Default cover mosaic",
  DEFAULT_COVER_MOSAIC_DESC: "When a note has neither a cover property nor a default cover image, show a mosaic in this color scheme instead. None = no cover.",
  SCHEME_NONE: "none",
